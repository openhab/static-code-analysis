...
/**
 * Checks if one of the JDK provided method which implicitly uses the default locale is used.
 * <p>
...
public class ImplicitDefaultLocaleRule extends AbstractJavaRulechainRule {
    ...
    private static final List<InvocationMatcher> METHODS = List.of( //
            ...
            InvocationMatcher.parse("java.text.DateFormatSymbols#DateFormatSymbols()"), //
            InvocationMatcher.parse("java.text.DateFormatSymbols#getInstance()"), //
            InvocationMatcher.parse("java.text.DecimalFormat#DecimalFormat()"), //
            InvocationMatcher.parse("java.text.DecimalFormat#DecimalFormat(java.lang.String)"), //
            InvocationMatcher.parse("java.text.DecimalFormatSymbols#DecimalFormatSymbols()"), //
            InvocationMatcher.parse("java.text.DecimalFormatSymbols#getInstance()"), //
            InvocationMatcher.parse("java.text.MessageFormat#MessageFormat(java.lang.String)"), //
            ...
            InvocationMatcher.parse("java.text.SimpleDateFormat#SimpleDateFormat()"), //
            InvocationMatcher.parse("java.text.SimpleDateFormat#SimpleDateFormat(java.lang.String)"), //
            InvocationMatcher
                    .parse("java.text.SimpleDateFormat#SimpleDateFormat(java.lang.String,java.text.DateFormatSymbols)"), //
            InvocationMatcher.parse("java.time.format.DateTimeFormatterBuilder#toFormatter()"), //
            InvocationMatcher.parse("java.util.Calendar#Calendar()"), //
            ...
            InvocationMatcher.parse("java.util.Formatter#Formatter()"), //
            InvocationMatcher.parse("java.util.Formatter#Formatter(java.lang.Appendable)"), //
            InvocationMatcher.parse("java.util.Formatter#Formatter(java.lang.String)"), //
            InvocationMatcher.parse("java.util.Formatter#Formatter(java.lang.String,java.lang.String)"), //
            InvocationMatcher.parse("java.util.Formatter#Formatter(java.io.File)"), //
            InvocationMatcher.parse("java.util.Formatter#Formatter(java.io.File,java.lang.String)"), //
            InvocationMatcher.parse("java.util.Formatter#Formatter(java.io.PrintStream)"), //
            InvocationMatcher.parse("java.util.Formatter#Formatter(java.io.OutputStream)"), //
            InvocationMatcher.parse("java.util.Formatter#Formatter(java.io.OutputStream,java.lang.String)"), //
            InvocationMatcher.parse("java.util.GregorianCalendar#GregorianCalendar()"), //
            InvocationMatcher.parse("java.util.GregorianCalendar#GregorianCalendar(java.util.TimeZone)"), //
    ...
    public String getDescription() {
        return "Methods that implicitly use the default Locale can lead to bugs. Use an overloaded version with an explicit Locale, and specify 'Locate.getDefault()' if the default Locale is desired.";
    }
