...
public class PomXmlCheckTest extends AbstractStaticCheckTest {
    ...
    public void testValidPom() throws Exception {
        verifyPomXmlFile("valid_pom_xml_directory", CommonUtils.EMPTY_STRING_ARRAY);
    }
    ...
    public void testMasterPom() throws Exception {
        ...
        verify(createChecker(config), testFileAbsolutePath, CommonUtils.EMPTY_STRING_ARRAY);
    }
