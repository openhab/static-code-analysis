...
import org.openhab.tools.analysis.checkstyle.ExportedJavadocTypeCheck;
...
/**
 * Tests for {@link ExportedJavadocTypeCheck}
 * @author Velin Yordanov - initial contribution
 *
 */
public class ExportedJavadocTypeCheckTest extends AbstractStaticCheckTest {
    private static final String LOG_MESSAGE = "javadoc.missing";
    private final Configuration config = createModuleConfig(ExportedJavadocTypeCheck.class);
    
    @Test
    public void shouldLogWhenPackageIsExported() throws Exception {
        verifyJavadoc("exportedPackageFile.java", generateExpectedMessages(28,LOG_MESSAGE));
    }
    ...
    @Test
    public void shouldNotLogWhenPackageIsExportedButClassHasJavadoc() throws Exception {
    ...
    protected String getPackageLocation() {
        return "checkstyle/exportedJavadocTypeCheckTest";
    }
}
