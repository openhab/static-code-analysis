...
| **maven.spotbugs.version** | String | The version of the spotbugs-maven-plugin that will be used (default value is **4.0.0**) |
| **spotbugs.version** | String | The version of SpotBugs that will be used (default value is **4.0.1**) |
