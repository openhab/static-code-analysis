...
## E. Logging
1. As we are in a dynamic OSGi environment, loggers should be non-static, when ever possible and have the name logger. - `Work in Progress` [issue](https://github.com/openhab/static-code-analysis/issues/37)
